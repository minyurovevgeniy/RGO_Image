...
<html>
	...
	<body>
		<div id="header"></div>
		<div id="content">
			<form action="./loadStudents_result.php" method="post" enctype="multipart/form-data">
					<table>
						<tr>
						...
						<tr>
							<td>Номер колонки с фамилией</td><td><input type="text" name="surname_column"></td>
						</tr>
						<tr>
							<td>Номер колонки с именем</td><td><input type="text" name="name_column"></td>
						</tr>
						<tr>
							<td>Номер колонки с отчеством</td><td><input type="text" name="patronymic_column"></td>
						</tr>
						<tr>
							<td>Номер колонки с группой</td><td><input type="text" name="group_column"></td>
						</tr>
						<tr>
